...
@inject(stores => ({
  ...
  removeMember: async user => {
    var roomid = (stores.members.show && stores.members.user.UserName) || stores.chat.user.UserName;
  ...
  isme: () => {
    return stores.session.user && stores.userinfo.user.UserName === stores.session.user.User.UserName;
  },
}))
@observer
class UserInfo extends Component {
  ...
  render() {
    ...
    return (
      <Modal onCancel={() => this.handleClose()} show={this.props.show}>
