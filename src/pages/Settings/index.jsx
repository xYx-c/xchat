        ...
        <div className={classes.column}>
          ...
          <ul>
            ...
            <li className={classes.downloads}>
              <div>
                <input onChange={e => setDownloads(e.target.files[0])} ref="downloads" type="file" />
                <p>Downloads</p>
            ...
            <li>
              <label htmlFor="alwaysOnTop">
                ...
                <Switch checked={alwaysOnTop} id="alwaysOnTop" onChange={e => setAlwaysOnTop(e.target.checked)} />
              </label>
            </li>
            ...
            <li>
              <label htmlFor="blockRecall">
                ...
                <Switch checked={blockRecall} id="blockRecall" onChange={e => setBlockRecall(e.target.checked)} />
              </label>
            </li>
            ...
            <li>
              <label htmlFor="showRedIcon">
                ...
                <Switch checked={showRedIcon} id="showRedIcon" onChange={e => setShowRedIcon(e.target.checked)} />
              </label>
            </li>
            ...
            <li>
              <label htmlFor="startup">
                ...
                <Switch checked={startup} id="startup" onChange={e => setStartup(e.target.checked)} />
              </label>
            </li>
          </ul>
        </div>
